...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  public:
    ...
    ~MyGLWidget ();
  public slots:
    //slot per canvia les camaras clican els buttons radio
    void canvicamara1();
    void canvicamara2();
  ...
  private:
    ...
    virtual void MortyTransform2(glm::vec3 posMorty2,float angleMorty2);
    ...
    // uniform locations
    GLuint transLoc, viewLoc, projLoc,morty2Loc;
    ...
    glm::mat4 TGMorty2;
    // Variable per guardar la distancia del obs a VRP
    float d= sqrt(334);
    //Variable gir de rick
    float girRick=180.f;
    //gir i pos del portal
    float girPortal=180.f;
    float portx=-2.5;
    float portz=-3;
    //variable per si pintar o no el portal
    bool turnport=true;
    //variable per pintar o no el morty2
    bool morty2=false;
    //posicio del morty i angle del morty
    glm::vec3 posMorty2;
    float angleMorty2;
    //boolea per canviar de camara i per pintar el morty2 de vermell
    bool camara2=false;
    bool pinta2=false;
};
