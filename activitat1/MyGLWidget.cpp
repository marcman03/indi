...
void MyGLWidget::initializeGL ()
{
  ...
  creaBuffersCama();
  creaBuffersCorona();
  glUniform1i(samarretaLoc, samarreta);
}
...
void MyGLWidget::modelRotateTransform () {
    glm::mat4 RM(1.0f);
    RM = glm::rotate(RM,glm::radians(roty),glm::vec3(0.0,1.0,0.0));
    glUniformMatrix4fv (rotateLoc, 1, GL_FALSE, &RM[0][0]);
}
...
void MyGLWidget::modelTransformBracDret()
{
  ...
  TG = glm::translate(TG, glm::vec3(0.15f,0.15f,0.0f));
  TG = glm::scale(TG,glm::vec3 (0.2f,0.2f,0.0f));
  TG = glm::rotate(TG,glm::radians(rot),glm::vec3 (0,0,1 ));
...
{
  glm::mat4 TG(1.0f);
  TG = glm::translate(TG, glm::vec3(0.0f,0.70f,0.0f));
  TG = glm::scale(TG,glm::vec3 (0.2f,0.2f,0.0f));
  glUniformMatrix4fv(TGLoc, 1, GL_FALSE, &TG[0][0]); 
}
...
void MyGLWidget::carregaShaders()
{
  ...
  samarretaLoc= glGetUniformLocation(program->programId(), "boolsamarreta");
  rotateLoc = glGetUniformLocation (program->programId(), "RM");
